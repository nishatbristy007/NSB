...
file_csv = open("/home/bayzid/Documents/Bristy/Skmer/SIMULATIONS/python_simulator_full/dist_params.csv","a")
...
def clcJaccard(folderpath, files, i, j,filename,freqs_1,freqs_2,subs_1,subs_2,k):
    ...
    if subs_1 ==0 and (subs_2==1 or subs_2==2):
        ...
        expected_rand_match = round(2*freqs_1[4]*freqs_2[4]*q**k)
